"""
Base Django settings for HR-Plus.
...
# Middleware — order is IMMUTABLE per CLAUDE.md
MIDDLEWARE = [
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'hrplus'),
        'USER': os.environ.get('DB_USER', 'hrplus'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'hrplus'),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'HR-Plus API',
    'DESCRIPTION': 'Enterprise HR Hiring Platform API',
    'VERSION': '1.0.0',
...
AWS_STORAGE_BUCKET_NAME = os.environ.get('AWS_STORAGE_BUCKET_NAME', 'hrplus-uploads')
...
# Field encryption key (django-fernet-encrypted-fields)
FIELD_ENCRYPTION_KEY = os.environ.get('FIELD_ENCRYPTION_KEY', '')
SALT_KEY = os.environ.get('SALT_KEY', FIELD_ENCRYPTION_KEY)  # Required by encrypted_fields
