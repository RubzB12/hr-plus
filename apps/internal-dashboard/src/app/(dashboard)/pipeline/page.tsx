          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={280}>
              ...
              >
                ...
                />
                <Tooltip
                  formatter={(value: number | string | undefined) => [`${value ?? 0}%`, 'Conversion Rate']}
                />
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b">
                    <th className="text-left py-2 pr-4 font-medium text-muted-foreground">Requisition</th>
                    <th className="text-left py-2 pr-4 font-medium text-muted-foreground">Department</th>
                    <th className="text-left py-2 pr-4 font-medium text-muted-foreground">Recruiter</th>
                    <th className="text-left py-2 pr-4 font-medium text-muted-foreground">Headcount</th>
                    <th className="text-left py-2 pr-4 font-medium text-muted-foreground">Days Open</th>
                  ...
                  {requisitions.map((req) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className={`py-3 pr-4 tabular-nums ${daysClass}`}>
                          {days}d
                        </td>
                        <td className="py-3">
                          <Link
